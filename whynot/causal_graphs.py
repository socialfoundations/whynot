...
def run_to_box(run, trace_ctx, skip_args=None):
    ...
    Returns
    -------
        boxed_run: whynot.framework.Run
...
def build_dynamics_graph(simulator, runs, config, config_nodes=False):
    ...
    ----------
        ...
        runs: list
            List of whynot.framework.Runs objects generated by the simulator
        config: whynot.simulators.infrastructure.BaseConfig
...
def ate_graph_builder(simulator, run, config, intervention, treatment_dependencies,
    ...
    ----------
        ...
        intervention: whynot.simulators.infrastructure.BaseIntervention
